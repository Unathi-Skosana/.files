...
" Website:      https://github.com/ghifarit53/retro.vim/
" License:      MIT
" -----------------------------------------------------------------------------
...
" Configuration: {{{
let s:configuration = {}
let s:configuration.transparent_background = get(g:, 'retro_transparent_background', 0)
let s:configuration.menu_selection_background = get(g:, 'retro_menu_selection_background', 'green')
let s:configuration.disable_italic_comment = get(g:, 'retro_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'retro_enable_italic', 0)
